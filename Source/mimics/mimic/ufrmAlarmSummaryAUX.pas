...
type
  TfrmAlarmSummaryAUX = class(TfrmMimics)
    lblAlmStr: TLabel;
    lblAckStr: TLabel;
...
var
  frmAlarmSummaryAUX: TfrmAlarmSummaryAUX;

implementation

{$R *.dfm}

procedure TfrmAlarmSummaryAUX.CountDuration(Sender: TObject);
var
  i : Integer;
  li : TListItem;
...
procedure TfrmAlarmSummaryAUX.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryAUX.FormDestroy(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryAUX.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryAUX.lvAlarmSummaryCustomDrawItem(
...
procedure TfrmAlarmSummaryAUX.SetAlarmList(aAlarmList: TList;

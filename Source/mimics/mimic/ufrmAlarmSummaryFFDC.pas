...
type
  TfrmAlarmSummaryFFDC = class(TfrmMimics)
    lblAlmStr: TLabel;
    lblAckStr: TLabel;
...
var
  frmAlarmSummaryFFDC: TfrmAlarmSummaryFFDC;

implementation

{$R *.dfm}

{ TfrmAlarmSummaryFFDC }

procedure TfrmAlarmSummaryFFDC.CountDuration(Sender: TObject);
var
  i : Integer;
  li : TListItem;
...
procedure TfrmAlarmSummaryFFDC.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryFFDC.FormDestroy(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryFFDC.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryFFDC.lvAlarmSummaryCustomDrawItem(
...
procedure TfrmAlarmSummaryFFDC.SetAlarmList(aAlarmList: TList;

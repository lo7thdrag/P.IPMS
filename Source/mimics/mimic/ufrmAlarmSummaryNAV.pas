...
type
  TfrmAlarmSummaryNAV = class(TfrmMimics)
    lblAlmStr: TLabel;
    lblAckStr: TLabel;
...
var
  frmAlarmSummaryNAV: TfrmAlarmSummaryNAV;
...
procedure TfrmAlarmSummaryNAV.CountDuration(Sender: TObject);
var
  i : Integer;
  li : TListItem;
...
procedure TfrmAlarmSummaryNAV.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryNAV.FormDestroy(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryNAV.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryNAV.lvAlarmSummaryCustomDrawItem(
...
procedure TfrmAlarmSummaryNAV.SetAlarmList(aAlarmList: TList;

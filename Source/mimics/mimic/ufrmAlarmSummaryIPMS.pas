...
type
  TfrmAlarmSummaryIPMS = class(TfrmMimics)
    lblAlmStr: TLabel;
    lblAckStr: TLabel;
...
var
  frmAlarmSummaryIPMS: TfrmAlarmSummaryIPMS;

implementation

{$R *.dfm}

{ TfrmAlarmSummaryIPMS }

procedure TfrmAlarmSummaryIPMS.CountDuration(Sender: TObject);
var
  i : Integer;
  li : TListItem;
...
procedure TfrmAlarmSummaryIPMS.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryIPMS.FormDestroy(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryIPMS.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryIPMS.lvAlarmSummaryCustomDrawItem(
...
procedure TfrmAlarmSummaryIPMS.SetAlarmList(aAlarmList: TList;

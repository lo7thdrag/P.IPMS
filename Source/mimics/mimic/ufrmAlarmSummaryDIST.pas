...
type
  TfrmAlarmSummaryDIST = class(TfrmMimics)
    lblAlmStr: TLabel;
    lblAckStr: TLabel;
...
var
  frmAlarmSummaryDIST: TfrmAlarmSummaryDIST;

implementation

{$R *.dfm}

procedure TfrmAlarmSummaryDIST.CountDuration(Sender: TObject);
var
  i : Integer;
  li : TListItem;
...
procedure TfrmAlarmSummaryDIST.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryDIST.FormDestroy(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryDIST.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryDIST.lvAlarmSummaryCustomDrawItem(
...
procedure TfrmAlarmSummaryDIST.SetAlarmList(aAlarmList: TList;

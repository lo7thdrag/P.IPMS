...
type
  TfrmAlarmSummaryHVAC = class(TfrmMimics)
    lblAlmStr: TLabel;
    lblAckStr: TLabel;
...
var
  frmAlarmSummaryHVAC: TfrmAlarmSummaryHVAC;

implementation

{$R *.dfm}

{ TfrmAlarmSummaryHVAC }

procedure TfrmAlarmSummaryHVAC.CountDuration(Sender: TObject);
var
  i : Integer;
  li : TListItem;
...
procedure TfrmAlarmSummaryHVAC.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryHVAC.FormDestroy(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryHVAC.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryHVAC.lvAlarmSummaryCustomDrawItem(
...
procedure TfrmAlarmSummaryHVAC.SetAlarmList(aAlarmList: TList;

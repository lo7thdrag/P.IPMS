...
uses
  ...
  uVerticalBar, uShortcut;

type
  TfrmMESB_Exhaust = class(TfrmMimics)
    Image1: TImage;
...
var
  frmMESB_Exhaust: TfrmMESB_Exhaust;

implementation

{$R *.dfm}

procedure TfrmMESB_Exhaust.FormResize(Sender: TObject);
begin
  inherited;

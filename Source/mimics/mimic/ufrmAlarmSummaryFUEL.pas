...
type
  TfrmAlarmSummaryFUEL = class(TfrmMimics)
    lblAlmStr: TLabel;
    lblAckStr: TLabel;
...
var
  frmAlarmSummaryFUEL: TfrmAlarmSummaryFUEL;

implementation

{$R *.dfm}

procedure TfrmAlarmSummaryFUEL.CountDuration(Sender: TObject);
var
  i : Integer;
  li : TListItem;
...
procedure TfrmAlarmSummaryFUEL.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryFUEL.FormDestroy(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryFUEL.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryFUEL.lvAlarmSummaryCustomDrawItem(
...
procedure TfrmAlarmSummaryFUEL.SetAlarmList(aAlarmList: TList;

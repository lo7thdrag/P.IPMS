...
type
  TfrmAlarmSummaryDG = class(TfrmMimics)
    lblAlmStr: TLabel;
    lblAckStr: TLabel;
...
var
  frmAlarmSummaryDG: TfrmAlarmSummaryDG;

implementation

{$R *.dfm}

procedure TfrmAlarmSummaryDG.CountDuration(Sender: TObject);
var
  i : Integer;
  li : TListItem;
...
procedure TfrmAlarmSummaryDG.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryDG.FormDestroy(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryDG.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryDG.lvAlarmSummaryCustomDrawItem(
...
procedure TfrmAlarmSummaryDG.SetAlarmList(aAlarmList: TList;

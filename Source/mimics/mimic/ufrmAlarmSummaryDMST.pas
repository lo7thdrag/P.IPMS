...
type
  TfrmAlarmSummaryDMST = class(TfrmMimics)
    lblAlmStr: TLabel;
    lblAckStr: TLabel;
...
var
  frmAlarmSummaryDMST: TfrmAlarmSummaryDMST;

implementation

{$R *.dfm}

procedure TfrmAlarmSummaryDMST.CountDuration(Sender: TObject);
var
  i : Integer;
  li : TListItem;
...
procedure TfrmAlarmSummaryDMST.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryDMST.FormDestroy(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryDMST.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryDMST.lvAlarmSummaryCustomDrawItem(
...
procedure TfrmAlarmSummaryDMST.SetAlarmList(aAlarmList: TList;

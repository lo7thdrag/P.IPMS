...
type
  TfrmAlarmSummaryPROP = class(TfrmMimics)
    lblAlmStr: TLabel;
    lblAckStr: TLabel;
...
var
  frmAlarmSummaryPROP: TfrmAlarmSummaryPROP;

implementation

{$R *.dfm}

procedure TfrmAlarmSummaryPROP.CountDuration(Sender: TObject);
var
  i : Integer;
  li : TListItem;
...
procedure TfrmAlarmSummaryPROP.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryPROP.FormDestroy(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryPROP.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TfrmAlarmSummaryPROP.lvAlarmSummaryCustomDrawItem(
...
procedure TfrmAlarmSummaryPROP.SetAlarmList(aAlarmList: TList;

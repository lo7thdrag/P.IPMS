...
//      SetValueBool(C_SWITCHBOARD, 3, True, epPMSEsbCBIntr)
      ...
      SetValueBool(C_SWITCHBOARD, 3, False, epPMSMsbCBShore)
    else if TButton(Sender).Name = 'btnCBCloseShore' then
      SetValueBool(C_SWITCHBOARD, 3, True, epPMSMsbCBShore)
  end;
end;

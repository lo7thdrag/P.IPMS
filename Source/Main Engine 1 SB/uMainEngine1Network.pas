...
type
   TMainEngine1Network = class (TNetworkManager)
...
constructor TMainEngine1Network.Create;
begin
  inherited;
...
destructor TMainEngine1Network.Destroy;
begin

  inherited;
end;

procedure TMainEngine1Network.OnConnected(Sender: TObject);
begin
  inherited;
...
procedure TMainEngine1Network.OnDisconnected(Sender: TObject);
begin
  inherited;
...
procedure TMainEngine1Network.StartNetwork;
begin
  inherited;
...
procedure TMainEngine1Network.StopNetwork;
begin
  inherited;

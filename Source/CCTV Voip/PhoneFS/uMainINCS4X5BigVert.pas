...
procedure TfrmLenBigVert.ReceiveCloseOrder(Rec: TRecData2DOrder);
begin
  ClosePhone;
end;

procedure TfrmLenBigVert.ButtonDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmLenBigVert.ButtonUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmLenBigVert.ClearAndDelList(aList: TList);
var
  aObj: TObject;
  I: Integer;
begin
...
procedure TfrmLenBigVert.Close1Click(Sender: TObject);
begin
  Application.Terminate;
end;

procedure TfrmLenBigVert.ClosePhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert.DrawAllButtons;
var
  I: Integer;
...
procedure TfrmLenBigVert.FormCreate(Sender: TObject);
var
  i : Integer;
  hMenuHandle: Integer;
...
procedure TfrmLenBigVert.FormDestroy(Sender: TObject);
begin
...
procedure TfrmLenBigVert.FormShow(Sender: TObject);
begin
...
function TfrmLenBigVert.GetButtonImgObjFromChName(aName: String): TObjButtonImage;
var
  I: Integer;
  aRole: TObjButtonImage;
  isFound: Boolean;
...
function TfrmLenBigVert.GetChNameFromTag(aBtnTag: Integer): string;
var
  I: Integer;
  aRole: TObjButtonImage;
begin
...
procedure TfrmLenBigVert.InitBaseGroupButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenBigVert.InitBaseExternalButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenBigVert.InitBaseInternalButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenBigVert.LoadFromImageListDown(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmLenBigVert.LoadFromImageListUp(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmLenBigVert.OnButtonClickedEvent(Sender: TObject);
var
...
procedure TfrmLenBigVert.OnTimerCall(Sender: TObject);
var
  i : integer;
  ChMap : TChannelMap;
begin
...
procedure TfrmLenBigVert.pnlConnectorClick(Sender: TObject);
begin
//  RunSimulation;
end;

procedure TfrmLenBigVert.ProcessMenuSelection(Sender: TObject);
var
  i, id , aTag : Integer;
  sExeRestart : string;
...
procedure TfrmLenBigVert.ReceiveInternalActivity(Rec: TRecInternal);
var
  i : Integer;
  ChMap : TChannelMap;
...
begin
  ...
  if VoipManager.SetConfig.idSkin <> 7 then Exit;
...
procedure TfrmLenBigVert.ReceiveModeCall(Rec: TRecCallMode);
begin
  if VoipManager.SetConfig.idSkin <> 7 then Exit;
  isAutoCall := Rec.IsAutoCall;
end;

procedure TfrmLenBigVert.RecvICSData(rec: TICSData);
begin
...
procedure TfrmLenBigVert.RecvICSOrder(rec: TRecOrder);
var
  px, py: Integer;
begin
...
//  lblStationName.Font.Style := [fsBold];
  ...
  px := frmLenBigVert.Left;
  py := frmLenBigVert.Top + (frmLenBigVert.Height div 2);
...
procedure TfrmLenBigVert.RestartPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert.RestartPhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert.RestartPhoneNConnector;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert.RunPhone;
var
  i : Integer;
  ChMap : TChannelMap;
...
procedure TfrmLenBigVert.RunSimulation;
var
  i : Integer;
  strXML : string;
...
procedure TfrmLenBigVert.SetButtonImgSelected(aStationName: string; SelectedState: Boolean);
var
  I: Integer;
  aRole: TObjButtonImage;
begin
...
function TfrmLenBigVert.SetCallInternal(ChName: string): Integer;
begin
  Result := -1;
  Result := GroupInternal.RoleList.IndexOf(ChName);
end;

procedure TfrmLenBigVert.SetIconTray;
var
  hMenuHandle: Integer;
begin
  hMenuHandle := GetSystemMenu(Handle, False);
...
procedure TfrmLenBigVert.SetPnlStatusConnect(aVisible: Boolean);
begin
...
procedure TfrmLenBigVert.ShutdownPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert.StationCallButtonSel(aBtnTag: Integer);
var
  i, id : integer;
  ChMap : TChannelMap;
...
procedure TfrmLenBigVert.StopPhone;
var
  i : Integer;
begin
  //Exit External Phone
...
procedure TfrmLenBigVert.tmrIncomingBlinkerTimer(Sender: TObject);
begin
...
procedure TfrmLenBigVert.tmrInternalRunChkTimer(Sender: TObject);
var
...
begin
  ...
  ButtonProperties.BtnImage := TImage.Create(frmLenBigVert.imgBgk);
  ButtonProperties.BtnImage.Parent := frmLenBigVert;
...
begin
  ...
  if Assigned(frmLenBigVert.EventOnButtonClicked) then
    frmLenBigVert.EventOnButtonClicked(Self);

...
type
  ...
  TfrmLenBigVert0812 = class(TForm)
    imgBgk: TImage;
...
var
  frmLenBigVert0812: TfrmLenBigVert0812;
...
procedure TfrmLenBigVert0812.btnTestButtonsCreateClick(Sender: TObject);
begin
  RunSimulation;
end;

procedure TfrmLenBigVert0812.ReceiveCloseOrder(Rec: TRecData2DOrder);
begin
  ClosePhone;
end;

procedure TfrmLenBigVert0812.ButtonDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmLenBigVert0812.ButtonUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmLenBigVert0812.ClearAndDelList(aList: TList);
var
  aObj: TObject;
  I: Integer;
begin
...
procedure TfrmLenBigVert0812.Close1Click(Sender: TObject);
begin
  Application.Terminate;
end;

procedure TfrmLenBigVert0812.ClosePhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert0812.DrawAllButtons;
var
  I: Integer;
...
procedure TfrmLenBigVert0812.FormCreate(Sender: TObject);
var
  i : Integer;
  hMenuHandle: Integer;
...
procedure TfrmLenBigVert0812.FormDestroy(Sender: TObject);
begin
...
procedure TfrmLenBigVert0812.FormShow(Sender: TObject);
begin
...
function TfrmLenBigVert0812.GetButtonImgObjFromChName(aName: String): TObjButtonImage;
var
  I: Integer;
  aRole: TObjButtonImage;
  isFound: Boolean;
...
function TfrmLenBigVert0812.GetChNameFromTag(aBtnTag: Integer): string;
var
  I: Integer;
  aRole: TObjButtonImage;
begin
...
procedure TfrmLenBigVert0812.imgBgkMouseDown(Sender: TObject;
...
procedure TfrmLenBigVert0812.InitBaseGroupButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenBigVert0812.InitBaseExternalButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenBigVert0812.InitBaseInternalButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenBigVert0812.LoadFromImageListDown(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmLenBigVert0812.LoadFromImageListUp(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmLenBigVert0812.OnButtonClickedEvent(Sender: TObject);
var
...
procedure TfrmLenBigVert0812.OnTimerCall(Sender: TObject);
var
  i : integer;
  ChMap : TChannelMap;
begin
...
procedure TfrmLenBigVert0812.pnlConnectorClick(Sender: TObject);
begin
//  RunSimulation;
end;

procedure TfrmLenBigVert0812.ProcessMenuSelection(Sender: TObject);
var
  i, id , aTag : Integer;
  sExeRestart : string;
...
procedure TfrmLenBigVert0812.ReceiveInternalActivity(Rec: TRecInternal);
var
  i : Integer;
  ChMap : TChannelMap;
...
begin
  ...
  if VoipManager.SetConfig.idSkin <> 8 then Exit;
...
procedure TfrmLenBigVert0812.ReceiveModeCall(Rec: TRecCallMode);
begin
  if VoipManager.SetConfig.idSkin <> 8 then Exit;
  isAutoCall := Rec.IsAutoCall;
end;

procedure TfrmLenBigVert0812.RecvICSData(rec: TICSData);
begin
...
procedure TfrmLenBigVert0812.RecvICSOrder(rec: TRecOrder);
var
  px, py: Integer;
begin
...
//  lblStationName.Font.Style := [fsBold];
  ...
  px := frmLenBigVert0812.Left;
  py := frmLenBigVert0812.Top + (frmLenBigVert0812.Height div 2);
...
procedure TfrmLenBigVert0812.RestartPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert0812.RestartPhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert0812.RestartPhoneNConnector;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert0812.RunPhone;
var
  i : Integer;
  ChMap : TChannelMap;
...
procedure TfrmLenBigVert0812.RunSimulation;
var
  i : Integer;
  strXML : string;
...
procedure TfrmLenBigVert0812.SetButtonImgSelected(aStationName: string; SelectedState: Boolean);
var
  I: Integer;
  aRole: TObjButtonImage;
begin
...
function TfrmLenBigVert0812.SetCallInternal(ChName: string): Integer;
begin
  Result := -1;
  Result := GroupInternal.RoleList.IndexOf(ChName);
end;

procedure TfrmLenBigVert0812.SetIconTray;
var
  hMenuHandle: Integer;
begin
  hMenuHandle := GetSystemMenu(Handle, False);
...
procedure TfrmLenBigVert0812.SetPnlStatusConnect(aVisible: Boolean);
begin
...
procedure TfrmLenBigVert0812.ShutdownPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert0812.StationCallButtonSel(aBtnTag: Integer);
var
  i, id : integer;
  ChMap : TChannelMap;
...
procedure TfrmLenBigVert0812.StopPhone;
var
  i : Integer;
begin
  //Exit External Phone
...
procedure TfrmLenBigVert0812.tmrIncomingBlinkerTimer(Sender: TObject);
begin
...
procedure TfrmLenBigVert0812.tmrInternalRunChkTimer(Sender: TObject);
var
...
begin
  ...
  ButtonProperties.BtnImage := TImage.Create(frmLenBigVert0812.imgBgk);
  ButtonProperties.BtnImage.Parent := frmLenBigVert0812;
...
begin
  ...
  if Assigned(frmLenBigVert0812.EventOnButtonClicked) then
    frmLenBigVert0812.EventOnButtonClicked(Self);

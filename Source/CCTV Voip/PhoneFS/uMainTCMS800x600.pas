...
uses
  ...
  uLoadGroupFromXML, uProgressBar, uSocketHandle, uDataVoipRecord, uLoadSetting,
  System.ImageList;

type
  TfrmMainTCMS800x600 = class(TForm)
  ...
  private
    ...
    procedure SetEnvironmentPage(PageID : Double); overload;
    procedure SetEnvironmentPage(PageID : Double; Caller: string); overload;
...
var
  frmMainTCMS800x600: TfrmMainTCMS800x600;
...
//String Function
procedure TfrmMainTCMS800x600.InitializeString(var s:String40);
var
  i : Integer;
begin
  s := '             |        |        |        ';
...
procedure TfrmMainTCMS800x600.ReceiveCloseOrder(Rec: TRecData2DOrder);
begin
  ClosePhone;
end;

procedure TfrmMainTCMS800x600.ClearSect(var s: String40; sec: Integer);
var i: Integer;
begin
  case sec of
    1: begin
...
procedure TfrmMainTCMS800x600.FillSect(var s: String40; sec: Integer; sInp: string);
var i, j, c: Integer;
begin
  c:= Length(sInp);
  case sec of
...
procedure TfrmMainTCMS800x600.FillChar(var s: String40; sec: Integer; aMode : integer);
begin
  case sec of
    1 : begin
          case aMode of
...
procedure TfrmMainTCMS800x600.ClosePhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainTCMS800x600.RestartPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainTCMS800x600.ShutdownPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainTCMS800x600.RestartPhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainTCMS800x600.RestartPhoneNConnector;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainTCMS800x600.ArchosHide1Click(Sender: TObject);
begin
...
procedure TfrmMainTCMS800x600.ButtonDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmMainTCMS800x600.ButtonUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmMainTCMS800x600.OnTimerCall(Sender: TObject);
var
  i : integer;
  ChMap : TChannelMap;
begin
...
procedure TfrmMainTCMS800x600.FormCreate(Sender: TObject);
var
  i : Integer;
  hMenuHandle: Integer;
...
procedure TfrmMainTCMS800x600.FormDestroy(Sender: TObject);
var
  i : Integer;
begin
...
procedure TfrmMainTCMS800x600.FormShow(Sender: TObject);
begin
...
procedure TfrmMainTCMS800x600.LoadFromImageListDown(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmMainTCMS800x600.LoadFromImageListUp(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmMainTCMS800x600.ReceiveInternalActivity(Rec: TRecInternal);
var
  i : Integer;
  ChMap : TChannelMap;
...
begin
  ...
  if VoipManager.SetConfig.idSkin <> 5 then Exit;
...
procedure TfrmMainTCMS800x600.ReceiveModeCall(Rec: TRecCallMode);
begin
  if VoipManager.SetConfig.idSkin <> 5 then Exit;
  isAutoCall := Rec.IsAutoCall;
end;

procedure TfrmMainTCMS800x600.RecvICSData(rec: TICSData);
begin
  if VoipManager.SetConfig.idSkin <> 5 then Exit;
...
//procedure TfrmMainTCMS800x600.RecvICSOrder(rec: TRecOrder);
//begin
//
//  case rec.OrderVal of
//
//    0: begin // terminates phone
//      MessageDlg(rec.OrderMsg, mtError, [mbOK], 0);
//      RunConsole1Click(CloseApplication1);
//    end;
//
//    1: begin // offers option whether to restart or terminate
//
//      if (MessageDlg(rec.OrderMsg, mtError, [mbOK, mbCancel], 0) = mrOk) then begin
//        // restart phone
//        RunConsole1Click(Restart1);
//      end
//      else begin
//        // close phone
//        RunConsole1Click(CloseApplication1);
...
//  lblStationName.Font.Style := [fsBold];
  ...
  px := frmMainTCMS800x600.Left;
  py := frmMainTCMS800x600.Top + (frmMainTCMS800x600.Height div 2);
...
procedure TfrmMainTCMS800x600.RunConsole1Click(Sender: TObject);
var
  i, id , aTag : Integer;
  sExeRestart : string;
...
procedure TfrmMainTCMS800x600.RunPhone;
var
  i : Integer;
  ChMap : TChannelMap;
...
procedure TfrmMainTCMS800x600.StopPhone;
var
  i : Integer;
begin
  //Exit External Phone
...
procedure TfrmMainTCMS800x600.tmrIncomingBlinkerTimer(Sender: TObject);
begin
...
procedure TfrmMainTCMS800x600.tmrInternalRunChkTimer(Sender: TObject);
var
...
procedure TfrmMainTCMS800x600.TrayMessage(var Msg: TMessage);
var
  P : Tpoint;
begin
  case Msg.lParam of
...
procedure TfrmMainTCMS800x600.RunSimulation;
var
  i : Integer;
...
procedure TfrmMainTCMS800x600.KeypadNumber_Set(aNumber, PageID: Double);
var
  i, id : integer;
  ChMap : TChannelMap;
...
function TfrmMainTCMS800x600.SetCallInternal(ChName: string): Integer;
begin
  Result := -1;
...
procedure TfrmMainTCMS800x600.SetEnvironmentPage(PageID: Double;
  Caller: string);
var
  strPg : string;
  i: Integer;
...
procedure TfrmMainTCMS800x600.SetIconTray;
var
  hMenuHandle: Integer;
begin
  hMenuHandle := GetSystemMenu(Handle, False);
...
procedure TfrmMainTCMS800x600.SetPnlStatusConnect(aVisible: Boolean);
begin

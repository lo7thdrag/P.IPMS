...
type
  ...
  TfrmIpmsHandledPhone = class(TForm)
    pnlComCctv: TPanel;
    pnlConnector: TPanel;
    pnlControl: TPanel;
    pnlSesVoip: TPanel;
    ...
    ShowPhone1: TMenuItem;
    HidePhone1: TMenuItem;
    N4: TMenuItem;
    erminatePhone1: TMenuItem;
  {$ENDREGION}
    ...
    procedure ShowPhone1Click(Sender: TObject);
  ...
  private
    ...
    procedure TrayMessage(var Msg: TMessage); message WM_ICONTRAY_IPMS;
...
var
  frmIpmsHandledPhone: TfrmIpmsHandledPhone;
...
procedure TfrmIpmsHandledPhone.FormCreate(Sender: TObject);
begin
  ...
  SetIconTray;
//  if VoipManager.SetConfig.TrayMode = 1 then begin
...
procedure TfrmIpmsHandledPhone.FormDestroy(Sender: TObject);
begin
  ClearAndDelList(ListInternal);
end;


procedure TfrmIpmsHandledPhone.ClearAndDelList(aList: TList);
var
  aObj: TObject;
  I: Integer;
begin
...
procedure TfrmIpmsHandledPhone.ClosePhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmIpmsHandledPhone.OnTimerCall(Sender: TObject);
var
  i : integer;
  ChMap : TChannelMap;
begin
...
procedure TfrmIpmsHandledPhone.ProcessMenuSelection(Sender: TObject);
var
  i, id , aTag : Integer;
  sExeRestart : string;
...
procedure TfrmIpmsHandledPhone.ReceiveCloseOrder(Rec: TRecData2DOrder);
begin
  ClosePhone;
end;

procedure TfrmIpmsHandledPhone.ReceiveInternalActivity(Rec: TRecInternal);
var
  i : Integer;
  ChMap : TChannelMap;
...
begin
  ...
  if VoipManager.SetConfig.idSkin <> 101 then Exit;
...
procedure TfrmIpmsHandledPhone.ReceiveModeCall(Rec: TRecCallMode);
begin
  if VoipManager.SetConfig.idSkin <> 101 then Exit;
  isAutoCall := Rec.IsAutoCall;
end;

procedure TfrmIpmsHandledPhone.RecvICSData(rec: TICSData);
begin
...
procedure TfrmIpmsHandledPhone.RecvICSOrder(rec: TRecOrder);
var
  px, py: Integer;
begin

  px := frmIpmsHandledPhone.Left;
  py := frmIpmsHandledPhone.Top + (frmIpmsHandledPhone.Height div 2);
...
procedure TfrmIpmsHandledPhone.RestartPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmIpmsHandledPhone.RestartPhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmIpmsHandledPhone.RestartPhoneNConnector;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmIpmsHandledPhone.RunPhone;
var
  i : Integer;
  ChMap : TChannelMap;
...
procedure TfrmIpmsHandledPhone.RunSimulation;
var
  i : Integer;
...
function TfrmIpmsHandledPhone.SetCallInternal(ChName: string): Integer;
begin
  Result := -1;
  Result := GroupInternal.RoleList.IndexOf(ChName);
end;

procedure TfrmIpmsHandledPhone.SetPnlStatusConnect(aVisible: Boolean);
begin
...
procedure TfrmIpmsHandledPhone.ShowPhone1Click(Sender: TObject);
begin
...
procedure TfrmIpmsHandledPhone.ShutdownPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmIpmsHandledPhone.StationCallButtonSel(aBtnTag: Integer);
var
  i, id : integer;
  ChMap : TChannelMap;
...
procedure TfrmIpmsHandledPhone.StopPhone;
var
  i : Integer;
begin
  //Exit Internal Phone
...
procedure TfrmIpmsHandledPhone.lblIncomingMouseDown(Sender: TObject;
...
procedure TfrmIpmsHandledPhone.pnlControlClick(Sender: TObject);
begin
...
procedure TfrmIpmsHandledPhone.tmrIncomingBlinkerTimer(Sender: TObject);
begin
...
procedure TfrmIpmsHandledPhone.SetIconTray;
var
  hMenuHandle: Integer;
begin
...
//    cbSize := SizeOf(TrayIconData);
    ...
    uCallbackMessage := WM_ICONTRAY_IPMS;
...
procedure TfrmIpmsHandledPhone.TrayMessage(var Msg: TMessage);
var
  P : Tpoint;
begin
  case Msg.lParam of
    ...
    begin
      ...
      GetCursorPos(p);
      pmTrayMenu.Popup(p.x, p.y);
      PostMessage(Handle, WM_NULL, 0, 0);
    end;
  end;
end;

procedure TfrmIpmsHandledPhone.pnlSesVoipClick(Sender: TObject);
begin
...
procedure TfrmIpmsHandledPhone.imgCallBtnClick(Sender: TObject);
begin

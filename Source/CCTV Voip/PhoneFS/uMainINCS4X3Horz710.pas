...
//  C_ConsoleLanel_Height = 55;
  C_Const_Max_Col = 4;
  C_Const_Max_Row = 3;
  C_Stations_Btn_Offset_Left = 60;
  C_Stations_Btn_Offset_Top = 205;
  C_Stations_Btn_Width = 119;
  C_Stations_Btn_Height = 50;
  C_Stations_Btn_Spacing = 16;
  C_GroupSel_Btn_Offset_Left = 56;
  C_GroupSel_Btn_Offset_Top = 148;
  C_GroupSel_Btn_Width = 126;
  C_GroupSel_Btn_Height = 50;
  C_GroupSel_Btn_Spacing = 8;
  C_ConsoleLabel_Left = 78;
  C_ConsoleLabel_Top = 16;
...
procedure TfrmLenHorz710.btnTestButtonsCreateClick(Sender: TObject);
begin
  RunSimulation;
end;

procedure TfrmLenHorz710.ReceiveCloseOrder(Rec: TRecData2DOrder);
begin
  ClosePhone;
end;

procedure TfrmLenHorz710.ButtonDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmLenHorz710.ButtonUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmLenHorz710.ClearAndDelList(aList: TList);
var
  aObj: TObject;
  I: Integer;
begin
...
procedure TfrmLenHorz710.Close1Click(Sender: TObject);
begin
  Application.Terminate;
end;

procedure TfrmLenHorz710.ClosePhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenHorz710.DrawAllButtons;
var
  I: Integer;
...
procedure TfrmLenHorz710.FormCreate(Sender: TObject);
var
  i : Integer;
  hMenuHandle: Integer;
...
procedure TfrmLenHorz710.FormDestroy(Sender: TObject);
begin
...
procedure TfrmLenHorz710.FormShow(Sender: TObject);
begin
...
function TfrmLenHorz710.GetButtonImgObjFromChName(aName: String): TObjButtonImage;
var
  I: Integer;
  aRole: TObjButtonImage;
  isFound: Boolean;
...
function TfrmLenHorz710.GetChNameFromTag(aBtnTag: Integer): string;
var
  I: Integer;
  aRole: TObjButtonImage;
begin
...
procedure TfrmLenHorz710.imgBgkMouseDown(Sender: TObject;
...
procedure TfrmLenHorz710.InitBaseGroupButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenHorz710.InitBaseExternalButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenHorz710.InitBaseInternalButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenHorz710.LoadFromImageListDown(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmLenHorz710.LoadFromImageListUp(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmLenHorz710.OnButtonClickedEvent(Sender: TObject);
var
...
procedure TfrmLenHorz710.OnTimerCall(Sender: TObject);
var
  i : integer;
  ChMap : TChannelMap;
begin
...
procedure TfrmLenHorz710.pnlConnectorClick(Sender: TObject);
begin
//  RunSimulation;
end;

procedure TfrmLenHorz710.ProcessMenuSelection(Sender: TObject);
var
  i, id , aTag : Integer;
  sExeRestart : string;
...
procedure TfrmLenHorz710.ReceiveInternalActivity(Rec: TRecInternal);
var
  i : Integer;
  ChMap : TChannelMap;
...
begin
  ...
  if VoipManager.SetConfig.idSkin <> 11 then Exit;
...
procedure TfrmLenHorz710.ReceiveModeCall(Rec: TRecCallMode);
begin
  if VoipManager.SetConfig.idSkin <> 11 then Exit;
  isAutoCall := Rec.IsAutoCall;
end;

procedure TfrmLenHorz710.RecvICSData(rec: TICSData);
begin
...
procedure TfrmLenHorz710.RecvICSOrder(rec: TRecOrder);
var
  px, py: Integer;
begin
...
//  lblStationName.Font.Style := [fsBold];
  ...
  px := frmLenHorz710.Left;
  py := frmLenHorz710.Top + (frmLenHorz710.Height div 2);
...
procedure TfrmLenHorz710.RestartPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenHorz710.RestartPhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenHorz710.RestartPhoneNConnector;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenHorz710.RunPhone;
var
  i : Integer;
  ChMap : TChannelMap;
...
procedure TfrmLenHorz710.RunSimulation;
var
  i : Integer;
...
procedure TfrmLenHorz710.SetButtonImgSelected(aStationName: string; SelectedState: Boolean);
var
  I: Integer;
  aRole: TObjButtonImage;
begin
...
function TfrmLenHorz710.SetCallInternal(ChName: string): Integer;
begin
  Result := -1;
  Result := GroupInternal.RoleList.IndexOf(ChName);
end;

procedure TfrmLenHorz710.SetIconTray;
var
  hMenuHandle: Integer;
begin
  hMenuHandle := GetSystemMenu(Handle, False);
...
procedure TfrmLenHorz710.SetPnlStatusConnect(aVisible: Boolean);
begin
...
procedure TfrmLenHorz710.ShutdownPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenHorz710.StationCallButtonSel(aBtnTag: Integer);
var
  i, id : integer;
  ChMap : TChannelMap;
...
procedure TfrmLenHorz710.StopPhone;
var
  i : Integer;
begin
  //Exit External Phone
...
procedure TfrmLenHorz710.tmrIncomingBlinkerTimer(Sender: TObject);
begin
...
procedure TfrmLenHorz710.tmrInternalRunChkTimer(Sender: TObject);
var
...
begin
  ...
  ButtonProperties.BtnImage := TImage.Create(frmLenHorz710.imgBgk);
  ButtonProperties.BtnImage.Parent := frmLenHorz710;
...
begin
  ...
  if Assigned(frmLenHorz710.EventOnButtonClicked) then
    frmLenHorz710.EventOnButtonClicked(Self);

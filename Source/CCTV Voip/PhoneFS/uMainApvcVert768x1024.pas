...
const
  C_Const_Max_Col = 4;
  C_Const_Max_Row = 5;
  C_Stations_Btn_Offset_Left = 155;
...
type
  ...
  TfrmLenBigVertApvc768 = class(TForm)
    imgBgk: TImage;
...
var
  frmLenBigVertApvc768: TfrmLenBigVertApvc768;
...
procedure TfrmLenBigVertApvc768.ButtonDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
begin
  ...
  case aTag of
    ...
    22:
    begin
      LoadFromImageListDown(22, imgCal, FBitMap);
    end;

  end;
end;

procedure TfrmLenBigVertApvc768.ButtonUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmLenBigVertApvc768.ClearAndDelList(aList: TList);
var
  aObj: TObject;
  I: Integer;
begin
...
procedure TfrmLenBigVertApvc768.Close1Click(Sender: TObject);
begin
  Application.Terminate;
end;

procedure TfrmLenBigVertApvc768.ClosePhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVertApvc768.DrawAllButtons;
var
  I: Integer;
...
procedure TfrmLenBigVertApvc768.FormCreate(Sender: TObject);
var
  i : Integer;
  hMenuHandle: Integer;
...
procedure TfrmLenBigVertApvc768.FormDestroy(Sender: TObject);
begin
...
procedure TfrmLenBigVertApvc768.FormShow(Sender: TObject);
begin
...
function TfrmLenBigVertApvc768.GetButtonImgObjFromChName(aName: String): TObjButtonImage;
var
  I: Integer;
  aRole: TObjButtonImage;
  isFound: Boolean;
...
function TfrmLenBigVertApvc768.GetChNameFromTag(aBtnTag: Integer): string;
var
  I: Integer;
  aRole: TObjButtonImage;
begin
...
procedure TfrmLenBigVertApvc768.imgBgkMouseDown(Sender: TObject;
...
procedure TfrmLenBigVertApvc768.imgDebugClick(Sender: TObject);
begin
  //RunSimulation;
end;

procedure TfrmLenBigVertApvc768.InitBaseGroupButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenBigVertApvc768.InitBaseExternalButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenBigVertApvc768.InitBaseInternalButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenBigVertApvc768.LoadFromImageListDown(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmLenBigVertApvc768.LoadFromImageListUp(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmLenBigVertApvc768.OnButtonClickedEvent(Sender: TObject);
var
...
procedure TfrmLenBigVertApvc768.OnTimerCall(Sender: TObject);
var
  i : integer;
  ChMap : TChannelMap;
begin
...
procedure TfrmLenBigVertApvc768.pnlConnectorClick(Sender: TObject);
begin
//  RunSimulation;
end;

procedure TfrmLenBigVertApvc768.ProcessMenuSelection(Sender: TObject);
var
  i, id , aTag : Integer;
  sExeRestart : string;
...
procedure TfrmLenBigVertApvc768.ReceiveCloseOrder(Rec: TRecData2DOrder);
begin
  ClosePhone;
end;

procedure TfrmLenBigVertApvc768.ReceiveInternalActivity(Rec: TRecInternal);
var
  i : Integer;
  ChMap : TChannelMap;
...
procedure TfrmLenBigVertApvc768.ReceiveModeCall(Rec: TRecCallMode);
begin
  if VoipManager.SetConfig.idSkin <> 12 then Exit;
  isAutoCall := Rec.IsAutoCall;
end;

procedure TfrmLenBigVertApvc768.RecvICSData(rec: TICSData);
begin
...
procedure TfrmLenBigVertApvc768.RecvICSOrder(rec: TRecOrder);
var
  px, py: Integer;
begin
...
//  lblStationName.Font.Style := [fsBold];
  ...
  px := frmLenBigVertApvc768.Left;
  py := frmLenBigVertApvc768.Top + (frmLenBigVertApvc768.Height div 2);
...
procedure TfrmLenBigVertApvc768.RestartPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVertApvc768.RestartPhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVertApvc768.RestartPhoneNConnector;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVertApvc768.RunPhone;
var
  i : Integer;
  ChMap : TChannelMap;
...
procedure TfrmLenBigVertApvc768.RunSimulation;
var
  i : Integer;
...
procedure TfrmLenBigVertApvc768.SetButtonImgSelected(aStationName: string; SelectedState: Boolean);
var
  I: Integer;
  aRole: TObjButtonImage;
begin
...
function TfrmLenBigVertApvc768.SetCallInternal(ChName: string): Integer;
begin
  Result := -1;
  Result := GroupInternal.RoleList.IndexOf(ChName);
end;

procedure TfrmLenBigVertApvc768.SetIconTray;
var
  hMenuHandle: Integer;
begin
  hMenuHandle := GetSystemMenu(Handle, False);
...
procedure TfrmLenBigVertApvc768.SetPnlStatusConnect(aVisible: Boolean);
begin
...
procedure TfrmLenBigVertApvc768.ShutdownPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVertApvc768.StationCallButtonSel(aBtnTag: Integer);
var
  i, id : integer;
  ChMap : TChannelMap;
...
procedure TfrmLenBigVertApvc768.StopPhone;
var
  i : Integer;
begin
  //Exit External Phone
...
procedure TfrmLenBigVertApvc768.tmrIncomingBlinkerTimer(Sender: TObject);
begin
  {
...
procedure TfrmLenBigVertApvc768.tmrInternalRunChkTimer(Sender: TObject);
var
...
begin
  ...
  ButtonProperties.BtnImage := TImage.Create(frmLenBigVertApvc768.imgBgk);
  ButtonProperties.BtnImage.Parent := frmLenBigVertApvc768;
...
begin
  ...
  if Assigned(frmLenBigVertApvc768.EventOnButtonClicked) then
    frmLenBigVertApvc768.EventOnButtonClicked(Self);

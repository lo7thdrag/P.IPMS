...
type
  ...
  TfrmLenBigVert0710 = class(TForm)
    imgBgk: TImage;
...
var
  frmLenBigVert0710: TfrmLenBigVert0710;
...
procedure TfrmLenBigVert0710.btnTestButtonsCreateClick(Sender: TObject);
begin
  RunSimulation;
end;

procedure TfrmLenBigVert0710.ButtonDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmLenBigVert0710.ButtonUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmLenBigVert0710.ClearAndDelList(aList: TList);
var
  aObj: TObject;
  I: Integer;
begin
...
procedure TfrmLenBigVert0710.Close1Click(Sender: TObject);
begin
  Application.Terminate;
end;

procedure TfrmLenBigVert0710.ClosePhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert0710.DrawAllButtons;
var
  I: Integer;
...
procedure TfrmLenBigVert0710.FormCreate(Sender: TObject);
var
  i : Integer;
  hMenuHandle: Integer;
...
procedure TfrmLenBigVert0710.FormDestroy(Sender: TObject);
begin
...
procedure TfrmLenBigVert0710.FormShow(Sender: TObject);
begin
...
function TfrmLenBigVert0710.GetButtonImgObjFromChName(aName: String): TObjButtonImage;
var
  I: Integer;
  aRole: TObjButtonImage;
  isFound: Boolean;
...
function TfrmLenBigVert0710.GetChNameFromTag(aBtnTag: Integer): string;
var
  I: Integer;
  aRole: TObjButtonImage;
begin
...
procedure TfrmLenBigVert0710.imgBgkMouseDown(Sender: TObject;
...
procedure TfrmLenBigVert0710.InitBaseGroupButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenBigVert0710.InitBaseExternalButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenBigVert0710.InitBaseInternalButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmLenBigVert0710.LoadFromImageListDown(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmLenBigVert0710.LoadFromImageListUp(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmLenBigVert0710.OnButtonClickedEvent(Sender: TObject);
var
...
procedure TfrmLenBigVert0710.OnTimerCall(Sender: TObject);
var
  i : integer;
  ChMap : TChannelMap;
begin
...
procedure TfrmLenBigVert0710.pnlConnectorClick(Sender: TObject);
begin
//  RunSimulation;
end;

procedure TfrmLenBigVert0710.ProcessMenuSelection(Sender: TObject);
var
  i, id , aTag : Integer;
  sExeRestart : string;
...
procedure TfrmLenBigVert0710.ReceiveCloseOrder(Rec: TRecData2DOrder);
begin
  ClosePhone;
end;

procedure TfrmLenBigVert0710.ReceiveInternalActivity(Rec: TRecInternal);
var
  i : Integer;
  ChMap : TChannelMap;
...
begin
  ...
  if VoipManager.SetConfig.idSkin <> 9 then Exit;
...
procedure TfrmLenBigVert0710.ReceiveModeCall(Rec: TRecCallMode);
begin
  if VoipManager.SetConfig.idSkin <> 9 then Exit;
  isAutoCall := Rec.IsAutoCall;
end;

procedure TfrmLenBigVert0710.RecvICSData(rec: TICSData);
begin
...
procedure TfrmLenBigVert0710.RecvICSOrder(rec: TRecOrder);
var
  px, py: Integer;
begin
...
//  lblStationName.Font.Style := [fsBold];
  ...
  px := frmLenBigVert0710.Left;
  py := frmLenBigVert0710.Top + (frmLenBigVert0710.Height div 2);
...
procedure TfrmLenBigVert0710.RestartPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert0710.RestartPhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert0710.RestartPhoneNConnector;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert0710.RunPhone;
var
  i : Integer;
  ChMap : TChannelMap;
...
procedure TfrmLenBigVert0710.RunSimulation;
var
  i : Integer;
...
procedure TfrmLenBigVert0710.SetButtonImgSelected(aStationName: string; SelectedState: Boolean);
var
  I: Integer;
  aRole: TObjButtonImage;
begin
...
function TfrmLenBigVert0710.SetCallInternal(ChName: string): Integer;
begin
  Result := -1;
  Result := GroupInternal.RoleList.IndexOf(ChName);
end;

procedure TfrmLenBigVert0710.SetIconTray;
var
  hMenuHandle: Integer;
begin
  hMenuHandle := GetSystemMenu(Handle, False);
...
procedure TfrmLenBigVert0710.SetPnlStatusConnect(aVisible: Boolean);
begin
...
procedure TfrmLenBigVert0710.ShutdownPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmLenBigVert0710.StationCallButtonSel(aBtnTag: Integer);
var
  i, id : integer;
  ChMap : TChannelMap;
...
procedure TfrmLenBigVert0710.StopPhone;
var
  i : Integer;
begin
  //Exit External Phone
...
procedure TfrmLenBigVert0710.tmrIncomingBlinkerTimer(Sender: TObject);
begin
...
procedure TfrmLenBigVert0710.tmrInternalRunChkTimer(Sender: TObject);
var
...
begin
  ...
  ButtonProperties.BtnImage := TImage.Create(frmLenBigVert0710.imgBgk);
  ButtonProperties.BtnImage.Parent := frmLenBigVert0710;
...
begin
  ...
  if Assigned(frmLenBigVert0710.EventOnButtonClicked) then
    frmLenBigVert0710.EventOnButtonClicked(Self);

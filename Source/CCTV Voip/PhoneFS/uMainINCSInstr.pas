...
const
  C_Const_Max_Col = 4;
  C_Const_Max_Row = 5;
  C_Stations_Btn_Offset_Left = 91;
  C_Stations_Btn_Offset_Top = 225;
  C_Stations_Btn_Width = 88;
  C_Stations_Btn_Height = 75;
  C_Stations_Btn_Spacing = 10;
  C_GroupSel_Btn_Offset_Left = 88;
  C_GroupSel_Btn_Offset_Top = 153;
  C_GroupSel_Btn_Width = 94;
  C_GroupSel_Btn_Height = 60;
  C_GroupSel_Btn_Spacing = 4;
  C_ConsoleLabel_Left = 86;
...
var
  frmMainINCSInstr : TfrmMainINCSInstr ;
...
procedure TfrmMainINCSInstr .btnTestButtonsCreateClick(Sender: TObject);
begin
  RunSimulation;
end;

procedure TfrmMainINCSInstr.ReceiveCloseOrder(Rec: TRecData2DOrder);
begin
  ClosePhone;
end;

procedure TfrmMainINCSInstr .ButtonDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmMainINCSInstr .ButtonUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmMainINCSInstr .ClearAndDelList(aList: TList);
var
  aObj: TObject;
  I: Integer;
begin
...
procedure TfrmMainINCSInstr .Close1Click(Sender: TObject);
begin
  Application.Terminate;
end;

procedure TfrmMainINCSInstr .ClosePhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainINCSInstr .DrawAllButtons;
var
  I: Integer;
...
procedure TfrmMainINCSInstr .FormCreate(Sender: TObject);
var
  i : Integer;
  hMenuHandle: Integer;
...
procedure TfrmMainINCSInstr .FormDestroy(Sender: TObject);
begin
...
procedure TfrmMainINCSInstr .FormShow(Sender: TObject);
begin
...
function TfrmMainINCSInstr .GetButtonImgObjFromChName(aName: String): TObjButtonImage;
var
  I: Integer;
  aRole: TObjButtonImage;
  isFound: Boolean;
...
function TfrmMainINCSInstr .GetChNameFromTag(aBtnTag: Integer): string;
var
  I: Integer;
  aRole: TObjButtonImage;
begin
...
procedure TfrmMainINCSInstr .imgBgkMouseDown(Sender: TObject;
...
procedure TfrmMainINCSInstr .InitBaseGroupButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmMainINCSInstr .InitBaseExternalButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmMainINCSInstr .InitBaseInternalButtons;
var
  I, aRow, aCol: Integer;
  aCh : TChannelMap;
  aRole: TObjButtonImage;
...
procedure TfrmMainINCSInstr .LoadFromImageListDown(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmMainINCSInstr .LoadFromImageListUp(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmMainINCSInstr .OnButtonClickedEvent(Sender: TObject);
var
...
procedure TfrmMainINCSInstr .OnTimerCall(Sender: TObject);
var
  i : integer;
  ChMap : TChannelMap;
begin
...
procedure TfrmMainINCSInstr .pnlConnectorClick(Sender: TObject);
begin
//  RunSimulation;
end;

procedure TfrmMainINCSInstr .ProcessMenuSelection(Sender: TObject);
var
  i, id , aTag : Integer;
  sExeRestart : string;
...
procedure TfrmMainINCSInstr .ReceiveInternalActivity(Rec: TRecInternal);
var
  i : Integer;
  ChMap : TChannelMap;
...
begin
  ...
  if VoipManager.SetConfig.idSkin <> 100 then Exit;
...
procedure TfrmMainINCSInstr .ReceiveModeCall(Rec: TRecCallMode);
begin
  if VoipManager.SetConfig.idSkin <> 100 then Exit;
  isAutoCall := Rec.IsAutoCall;
end;

procedure TfrmMainINCSInstr .RecvICSData(rec: TICSData);
begin
...
procedure TfrmMainINCSInstr .RecvICSOrder(rec: TRecOrder);
var
  px, py: Integer;
begin
...
//  lblStationName.Font.Style := [fsBold];
  ...
  px := frmMainINCSInstr.Left;
  py := frmMainINCSInstr.Top + (frmMainINCSInstr.Height div 2);
...
procedure TfrmMainINCSInstr .RestartPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainINCSInstr .RestartPhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainINCSInstr .RestartPhoneNConnector;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainINCSInstr .RunPhone;
var
  i : Integer;
  ChMap : TChannelMap;
...
procedure TfrmMainINCSInstr .RunSimulation;
var
  i : Integer;
...
procedure TfrmMainINCSInstr .SetButtonImgSelected(aStationName: string; SelectedState: Boolean);
var
  I: Integer;
  aRole: TObjButtonImage;
begin
...
function TfrmMainINCSInstr .SetCallInternal(ChName: string): Integer;
begin
  Result := -1;
  Result := GroupInternal.RoleList.IndexOf(ChName);
end;

procedure TfrmMainINCSInstr .SetIconTray;
var
  hMenuHandle: Integer;
begin
  hMenuHandle := GetSystemMenu(Handle, False);
...
procedure TfrmMainINCSInstr .SetPnlStatusConnect(aVisible: Boolean);
begin
...
procedure TfrmMainINCSInstr .ShutdownPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainINCSInstr .StationCallButtonSel(aBtnTag: Integer);
var
  i, id : integer;
  ChMap : TChannelMap;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
         //Hangup
         mmo1.Lines.Add('VoipManager.SetConfig.aRole' + ' hang up from ' + ChMap.aChannelName);
      ...
      begin
        mmo1.Lines.Add(VoipManager.SetConfig.aRole + ' calling ' + ChMap.aChannelName);
...
procedure TfrmMainINCSInstr .StopPhone;
var
  i : Integer;
begin
  //Exit External Phone
...
procedure TfrmMainINCSInstr .tmrIncomingBlinkerTimer(Sender: TObject);
begin
...
procedure TfrmMainINCSInstr .tmrInternalRunChkTimer(Sender: TObject);
var
...
begin
  ...
  ButtonProperties.BtnImage := TImage.Create(frmMainINCSInstr .imgBgk);
  ButtonProperties.BtnImage.Parent := frmMainINCSInstr ;
  ...
  //with draw shapes
  GroupBtnFrameColor := TColor(RGB(200,200,200));
  StationBtnFrameColor := TColor(RGB(70,70,70));// $234EFC;
  ActBtnColor       := TColor(RGB(130,130,130));// $0B2965;
  GroupBtnActColor  := TColor(RGB(50,50,50));//$5B976A
  PsvBtnColor       := TColor(RGB(180,180,180));// $709FCD;
  GroupBtnPsvColor  := TColor(RGB(100,100,100));//$4272C6
...
begin
  ...
  if Assigned(frmMainINCSInstr .EventOnButtonClicked) then
    frmMainINCSInstr .EventOnButtonClicked(Self);

...
uses
  ...
  uLoadGroupFromXML, uProgressBar, uSocketHandle, uDataVoipRecord,
  System.ImageList;

type
  TfrmMainTCMS1440x900 = class(TForm)
...
var
  frmMainTCMS1440x900: TfrmMainTCMS1440x900;
...
//String Function
procedure TfrmMainTCMS1440x900.InitializeString(var s:String40);
var
  i : Integer;
begin
  s := '             |        |        |        ';
...
procedure TfrmMainTCMS1440x900.ClearSect(var s: String40; sec: Integer);
var i: Integer;
begin
  case sec of
    1: begin
...
procedure TfrmMainTCMS1440x900.FillSect(var s: String40; sec: Integer; sInp: string);
var i, j, c: Integer;
begin
  c:= Length(sInp);
  case sec of
...
procedure TfrmMainTCMS1440x900.FillChar(var s: String40; sec: Integer; aMode : integer);
begin
  case sec of
    1 : begin
          case aMode of
...
procedure TfrmMainTCMS1440x900.ClosePhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainTCMS1440x900.RestartPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainTCMS1440x900.ShutdownPC;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainTCMS1440x900.RestartPhone;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainTCMS1440x900.RestartPhoneNConnector;
var
  i : integer;
  DiffLeft,
  DiffTop : integer;
...
procedure TfrmMainTCMS1440x900.ArchosHide1Click(Sender: TObject);
begin
...
procedure TfrmMainTCMS1440x900.ButtonDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmMainTCMS1440x900.ButtonUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  aTag : Integer;
  aTImage : TImage;
...
procedure TfrmMainTCMS1440x900.OnTimerCall(Sender: TObject);
var
  i : integer;
  ChMap : TChannelMap;
begin
...
procedure TfrmMainTCMS1440x900.FormCreate(Sender: TObject);
var
  i : Integer;
  hMenuHandle: Integer;
...
procedure TfrmMainTCMS1440x900.FormDestroy(Sender: TObject);
var
  i : Integer;
begin
...
procedure TfrmMainTCMS1440x900.FormShow(Sender: TObject);
begin
...
procedure TfrmMainTCMS1440x900.LoadFromImageListDown(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmMainTCMS1440x900.LoadFromImageListUp(AIndex: Integer; AImage: TImage;
  ABitmap: TBitmap);
begin
...
procedure TfrmMainTCMS1440x900.ReceiveInternalActivity(Rec: TRecInternal);
var
  i : Integer;
  ChMap : TChannelMap;
...
procedure TfrmMainTCMS1440x900.ReceiveModeCall(Rec: TRecCallMode);
begin
  if VoipManager.SetConfig.idSkin <> 1 then Exit;
  isAutoCall := Rec.IsAutoCall;
end;

procedure TfrmMainTCMS1440x900.RecvICSData(rec: TICSData);
begin
  if VoipManager.SetConfig.idSkin <> 1 then Exit;
...
procedure TfrmMainTCMS1440x900.RunConsole1Click(Sender: TObject);
var
  i, id , aTag : Integer;
  sExeRestart : string;
...
procedure TfrmMainTCMS1440x900.RunPhone;
var
  i : Integer;
  ChMap : TChannelMap;
...
procedure TfrmMainTCMS1440x900.StopPhone;
var
  i : Integer;
begin
  //Exit External Phone
...
procedure TfrmMainTCMS1440x900.TrayMessage(var Msg: TMessage);
var
  P : Tpoint;
begin
  case Msg.lParam of
...
procedure TfrmMainTCMS1440x900.RunSimulation;
var
  i : Integer;
  strXML : string;
  ...
  aRowSection : Double;
begin
  if VoipManager.SetConfig.idSkin <> 4 then Exit;
...
procedure TfrmMainTCMS1440x900.KeypadNumber_Set(aNumber, PageID: Double);
var
  i, id : integer;
  ChMap : TChannelMap;
...
function TfrmMainTCMS1440x900.SetCallInternal(ChName: string): Integer;
begin
  Result := -1;
  Result := GroupInternal.RoleList.IndexOf(ChName);
end;

procedure TfrmMainTCMS1440x900.SetEnvironmentPage(PageID: Double);
var
  strPg : string;
  i: Integer;
...
procedure TfrmMainTCMS1440x900.SetIconTray;
var
  hMenuHandle: Integer;
begin
  hMenuHandle := GetSystemMenu(Handle, False);
...
procedure TfrmMainTCMS1440x900.SetPnlStatusConnect(aVisible: Boolean);
begin

...
//    C_ORD_SWT_INTERCLOSED = 12;
  ...
  C_INSTRUCTOR_COMMAND = 54;
    ...
    C_ORD_CLOSE_APP = 14;
    C_ORD_REFRESH_CON = 15;
    C_ORD_REFRESH_APP = 16;
  ...
  C_POWER_ID : array [0..2] of string = ('Power FWD', 'Power AFT', 'Power SHORE');
...
type
  ...
  E_PropsID = (
      ...
      epPCSMEActualSpeed, epPCSMEDelayActualSpeed, epPCSMEDelayActualSpeedPS, epPCSMEDelayActualSpeedSB, epPCSMEActualSpeedPS, epPCSMEActualSpeedSB,
      ...
      epPCSCPPSetPointPitch, epPCSCPPSetPointPitchPS, epPCSCPPSetPointPitchSB, epPCSCPPLeverPitch, epPCSCPPLeverPitchPS, epPCSCPPLeverPitchSB,

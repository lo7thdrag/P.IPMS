...
uses
  ufrmSafetiesStop, ufrmLineAExhaustGasTemperature, ufrmMenu, ufrmAlarms, ufrmCurves;
{$R *.dfm}

procedure TfrmLineBExhaustGasTemperature.btnAlarmsClick(Sender: TObject);
begin
  frmAlarms.Show;
  Self.Hide;
end;

procedure TfrmLineBExhaustGasTemperature.btnCurvesClick(Sender: TObject);
begin
  frmCurves.Show;
  Self.Hide;
end;

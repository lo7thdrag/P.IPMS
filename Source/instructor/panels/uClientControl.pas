...
begin
  ...
  if str = 'ACS' then
    ...
    result := Setting.GenPsFwdIP // '192.168.1.2'
  else if str = 'GEN SB FWD' then
    result := Setting.GenSbFwdIP // '192.168.1.2'
  else if str = 'GEN PS AFT' then
    result := Setting.GenPsAftIP // '192.168.1.2'
  else if str = 'GEN SB AFT' then
    result := Setting.GenSbAftIP // '192.168.1.2'
  else if str = 'GEN EMERGENCY' then
    result := Setting.GenEmergencyIP // '192.168.1.2'
  else if str = 'SHORE' then
    result := Setting.ShoreIP // '192.168.1.2'
  else if str = 'MAIN ENGINE 1 PS' then
    result := Setting.MainEngine1PsIP // '192.168.1.2'
  else if str = 'MAIN ENGINE 2 PS' then
    result := Setting.MainEngine2PsIP // '192.168.1.2'
  else if str = 'MAIN ENGINE 1 SB' then
    result := Setting.MainEngine1Sb // '192.168.1.2'
  else if str = 'MAIN ENGINE 2 SB' then
    result := Setting.MainEngine2Sb // '192.168.1.2'
  else if str = 'AUXILIARY - 1' then
    result := Setting.Auxiliary1 // '192.168.1.2'
  else if str = 'AUXILIARY - 2' then
    result := Setting.Auxiliary2 // '192.168.1.2'
  else if str = 'AUXILIARY - 3' then
    result := Setting.Auxiliary3 // '192.168.1.2'
  else if str = 'DIESEL GENERATOR - 1' then
    result := Setting.DieselGenerator1 // '192.168.1.2'
  else if str = 'DIESEL GENERATOR - 2' then
    result := Setting.DieselGenerator2 // '192.168.1.2'
  else if str = 'DIESEL GENERATOR - 3' then
    result := Setting.DieselGenerator3 // '192.168.1.2'
  else if str = 'DIESEL GENERATOR - 4' then
    result := Setting.DieselGenerator4;
end;

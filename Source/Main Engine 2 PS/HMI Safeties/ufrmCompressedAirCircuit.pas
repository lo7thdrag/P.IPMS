...
type
  TfrmCompressedAirCircuit = class(TForm)
    ...
    Image3: TImage;
    Image4: TImage;
    VrTCAirSealCompress: TVrAngularMeter;
    VrStartingAirPressureCompress: TVrAngularMeter;
    VrControlAirCompress: TVrAngularMeter;
    Panel3: TPanel;
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
    lblControlAirCompress: TLabel;
    Panel5: TPanel;
    Label9: TLabel;
    Label10: TLabel;
    lblStartingAirPressureCompress: TLabel;
    Panel6: TPanel;
    lblTCAirSealCompress: TLabel;
    Label16: TLabel;
    Label5: TLabel;
    Label6: TLabel;
    Label7: TLabel;
...
uses
  ufrmMenu, ufrmSafetiesStop, ufrmAlarms, ufrmCurves;
{$R *.dfm}
...
procedure TfrmCompressedAirCircuit.btnCurvesClick(Sender: TObject);
begin
  frmCurves.Show;
  Self.Hide;
end;

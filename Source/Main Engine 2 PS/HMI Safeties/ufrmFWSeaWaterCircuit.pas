...
uses
  ufrmAirGasCircuit, ufrmFuelOilCircuit, ufrmMenu, ufrmAlarms, ufrmCurves;
{$R *.dfm}

procedure TfrmFWSeaWaterCircuit.btnAlarmsClick(Sender: TObject);
begin
  frmAlarms.Show;
  Self.Hide;
end;

procedure TfrmFWSeaWaterCircuit.btnCurvesClick(Sender: TObject);
begin
  frmCurves.Show;
  Self.Hide;
end;

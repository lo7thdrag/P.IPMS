...
uses Clipbrd;
procedure TMainFormServo.ConnButtonClick(Sender: TObject);
begin
  ComTerminal.Connected := not ComTerminal.Connected;
end;

procedure TMainFormServo.ComPortAfterOpen(Sender: TObject);
begin
  ConnButton.Caption := 'Disconnect';
end;

procedure TMainFormServo.ComDataPacket1CustomStart(Sender: TObject;
...
procedure TMainFormServo.ComDataPacket1CustomStop(Sender: TObject; const Str: string;
                                                            var Pos: Integer);
begin
  if Pos >=0 then
...
procedure TMainFormServo.ComDataPacket1Packet(Sender: TObject; const Str: string);
begin
  StatusBar1.Panels[0].Text := 'FOUND: '+str+  '                                  '  ;
  ComDataPacket1.ResetBuffer;
end;

procedure TMainFormServo.ComPortAfterClose(Sender: TObject);
begin
  ConnButton.Caption := 'Connect';
end;

procedure TMainFormServo.Paste1Click(Sender: TObject);
var s:string;
begin
  s  := Clipboard.AsText;
  ComPort.WriteStr(s);
...
procedure TMainFormServo.PortButtonClick(Sender: TObject);
begin
  ComPort.ShowSetupDialog;
end;

procedure TMainFormServo.TermButtonClick(Sender: TObject);
begin
  ComTerminal.ShowSetupDialog;
end;

procedure TMainFormServo.FontButtonClick(Sender: TObject);
begin
  ComTerminal.SelectFont;
end;

procedure TMainFormServo.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TMainFormServo.FormShow(Sender: TObject);
begin
...
procedure TMainFormServo.Button1Click(Sender: TObject);
var  s:String;
begin

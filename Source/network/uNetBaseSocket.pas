...
//------------------------------------------------------------------------------
  ...
  private
    ...
    procedure SetSocketIdentifier(const Value: string);
  protected
    WSocket: TWSocket;
  ...
  public
    ...
    property SocketIdentifier : string read FSocketIdentifier write SetSocketIdentifier;
...
procedure TNetBaseSocket.SetSocketIdentifier(const Value: string);
begin
  FSocketIdentifier := Value;
end;
